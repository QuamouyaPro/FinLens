...
1. **Au début de toute session, lire [`SESSION_LOG.md`](SESSION_LOG.md)** —
...
2. **À la fin de toute session de travail** (avant que l'utilisateur ne
   ...
   `SESSION_LOG.md` résumant les changements de la session, puis committer et
   pousser sur `origin/main` (dépôt `QuamouyaPro/FinLens`).
